...
const roomMessages = {};
const roomClients  = {};
let globalSpotifyUri = 'spotify:embed:track:4PTG3Z6ehGkBFm6TuvYv2G'; // Varsayılan başlangıç şarkısı
...
wss.on('connection', (ws) => {
  ...
  ws.on('message', (raw) => {
    ...
    if (msg.type === 'spotify_change' && msg.uri) {
      ...
      // Normal Spotify linkini iframe embed formatına dönüştürme mantığı
...
// Ana dizindeki index.html dosyasını doğrudan render et
app.get('/', (req, res) => {
